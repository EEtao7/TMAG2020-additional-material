classdef Noload_Test < TestProject
    properties
        MyModel
        flux_PM
        cogging_torque
        fluxPM_documentsaddress = 'E:\My_Study\ZJU_master_study\master research\Low speed servo motor\Matlab_and_Simulink_documents\figure documents\Flux linkage';
        coggingTorque_documentsaddress = 'E:\My_Study\ZJU_master_study\master research\Low speed servo motor\Matlab_and_Simulink_documents\figure documents\cogging torque';
        fluxPM_figureaddress
        coggingTorque_figureaddress
    ...
    methods
        ...
        function FEA_analysis(obj)
            ...
            for alpha_deg = alpha_min:dalpha:alpha_max
                ...
                mo_close;
                delete('temp.ans');
                fprintf('% i of % i :: %f seconds ::  %f Web ::  %f N*m \n', round(Rotor_angle*obj.testmotor.rotor.pole_of_pairs_Rotor), obj.theta_max_deg,etime(clock,starttime), obj.flux_PM(m), obj.cogging_torque(m));
        ...
        function Save_Data(obj)
            ...
            obj.fluxPM_figureaddress = strcat(obj.fluxPM_documentsaddress,'\', figurename);
            savefig(obj.fluxPM_figureaddress);
            obj.testmotor.controlparameters.flux_PM =obj.flux_PM;
            
            % draw the cogging torque
            figure();
            ...
            title('Cogging Torque VS theta');
            grid on;
            % save the figure document and useful parameters
            figurename = strcat(obj.testmotor.name,'_Cogging_Torque.fig');
            obj.coggingTorque_figureaddress = strcat(obj.coggingTorque_documentsaddress,'\', figurename);
            savefig(obj.coggingTorque_figureaddress);
