function motor = Record_parameters_of_motor_relative_permeance(parameters_of_rotor, parameters_of_stator, parameters_of_other_part, parameters_of_space_harmonics, parameters_of_time_harmonics, parameters_of_performance)
% This function is used to initialize the parameters of motor in the relative
% permeance model
