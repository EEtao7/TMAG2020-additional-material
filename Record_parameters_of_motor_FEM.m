function motor = Record_parameters_of_motor_FEM(parameters_of_rotor, parameters_of_stator, parameters_of_other_part, parameters_of_performance)
% This function is used to initialize the parameters of motor in the FEM model
