%% Flux linkage Test Based on Linear Subdomain Model  (Conventional PMSM)
    ...
    for Pr = Pr_range
        ...
        for Ratio_of_tooth = Ratio_of_tooth_range
            ...
            if (mod(Ns, Np*t)==0 && Ps<Ns && Ps>0)
                parameters_of_performance.flux_linkage = Flux_linkage_calculation_based_on_linear_subdomain...
                    (parameters_of_rotor, parameters_of_stator, parameters_of_other_part, parameters_of_space_harmonics, parameters_of_time_harmonics);
            else
                parameters_of_performance.flux_linkage =0;
            end
            %% record the data 
            n = n+1;
            SD.motor(n) =  Record_parameters_of_motor_subdomain...
                (parameters_of_rotor, parameters_of_stator, parameters_of_other_part, parameters_of_space_harmonics, parameters_of_time_harmonics, parameters_of_performance);
        end
    end
end
toc
