classdef AGE_Outer_Rotor < Air_gap_Package.AirGap
...
%         end
        ...
        function outer_radius_of_AGE = get.outer_radius_of_AGE(obj)
            outer_radius_of_AGE = obj.rotor.inner_radious-0.25*obj.air_gap_length;
        end
        
        function inner_radius_of_AGE = get.inner_radius_of_AGE(obj)
            inner_radius_of_AGE =  obj.rotor.inner_radious-0.75*obj.air_gap_length;
        end
